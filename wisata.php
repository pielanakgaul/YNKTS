    ...
    <section class="destinations-area section-gap">
        <div class="container">
                        ...
                        <div class="details">
                            ...
                            <ul class="package-list">
                                <li class="d-flex justify-content-between align-items-center mt-1 mr-auto ml-auto">
                                    <span class="d-flex">
                                        <a href="https://goo.gl/maps/bkQojuoy6oemXiWcA" class="link-secondary"><svg class="mr-1" xmlns="http://www.w3.org/2000/svg" width="30" height="30" preserveAspectRatio="xMidYMid meet" viewBox="0 0 30 30">
                        ...
                        <div class="details">
                            ...
                            <ul class="package-list">
                                <li class="d-flex justify-content-between align-items-center">
                                    <span class="d-flex">
                                        <a href="https://goo.gl/maps/2mYcWaEDFXE6NU5RA" class="link-secondary"><svg class="mr-1" xmlns="http://www.w3.org/2000/svg" width="30" height="30" preserveAspectRatio="xMidYMid meet" viewBox="0 0 30 30">
                                                <path fill="currentColor" d="M12 12q.825 0 1.413-.588Q14 10.825 14 10t-.587-1.413Q12.825 8 12 8q-.825 0-1.412.587Q10 9.175 10 10q0 .825.588 1.412Q11.175 12 12 12Zm0 10q-4.025-3.425-6.012-6.363Q4 12.7 4 10.2q0-3.75 2.413-5.975Q8.825 2 12 2t5.587 2.225Q20 6.45 20 10.2q0 2.5-1.987 5.437Q16.025 18.575 12 22Z" />
                                            </svg></a>
                        ...
                        <div class="single-destinations">
                            ...
                            <div class="details">
                                ...
                                <ul class="package-list">
                                    <li class="d-flex justify-content-between align-items-center mt-1 mr-auto ml-auto">
                                        <span class="d-flex">
                                            <a href="https://goo.gl/maps/LZVGZdYtHTubGcY68" class="link-secondary"><svg class="mr-1" xmlns="http://www.w3.org/2000/svg" width="30" height="30" preserveAspectRatio="xMidYMid meet" viewBox="0 0 30 30">
                                                    <path fill="currentColor" d="M12 12q.825 0 1.413-.588Q14 10.825 14 10t-.587-1.413Q12.825 8 12 8q-.825 0-1.412.587Q10 9.175 10 10q0 .825.588 1.412Q11.175 12 12 12Zm0 10q-4.025-3.425-6.012-6.363Q4 12.7 4 10.2q0-3.75 2.413-5.975Q8.825 2 12 2t5.587 2.225Q20 6.45 20 10.2q0 2.5-1.987 5.437Q16.025 18.575 12 22Z" />
                                                </svg></a>
            ...
            <div class="justify-content-center align-items-center text-center mt-5">
                <a href="wisata2.php">
                    <button type="button" class="btn btn-dark" style="padding: 10px; margin: auto; border-radius: 25px; font-size: 22px;">Destinasi lainnya
                    </button>
                </a>
            </div>
        </div>
