...
$datas = query("SELECT * FROM wisata WHERE kategori LIKE '%budaya%'");
            ...
            <div class="row d-flex justify-content-center">
                <div class="menu-content pb-40 col-lg-8">
                    <div class="title text-center">
                        <h1 class="mb-10">Destinasi Budaya di Sulawesi Tenggara</h1>
                        <p>Destinasi budaya populer disetiap kabupaten yang ada di Sulawesi Tenggara</p>
                    </div>
                </div>
            </div>
            <?php
